-- ============================================
-- BASE DE DATOS ROOMMASTER - HOSTINGER
-- Sistema de Gestión Hotelera - SENA
-- ============================================
-- Este script crea la base de datos y las tablas
-- para el sistema RoomMaster para Hostinger
-- NOTA: Cambia "roommaster_db" por "u754245691_db_90IMt5ZM"


-- 1. CREAR LA BASE DE DATOS (SOLO SI NO EXISTE)
-- ============================================
-- EN HOSTINGER: Ya debes tener creada u754245691_db_90IMt5ZM
-- Si no, descomenta y ejecuta esta línea
-- CREATE DATABASE IF NOT EXISTS u754245691_db_90IMt5ZM;

USE u754245691_db_90IMt5ZM;
